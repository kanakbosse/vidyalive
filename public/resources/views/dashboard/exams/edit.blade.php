                                ...
                                <div class="row">
                                    <div class="col-md-8 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter title" value="{{ $exam->title }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Participating_college">Participating college</label>
                                            <input type="text" class="form-control" id="Participating_college" name="Participating_college" placeholder="Enter Participating college" value="{{ $exam->Participating_college }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Exam_Date">Exam Date</label>
                                            <input type="date" class="form-control" id="Exam_Date" name="Exam_Date" placeholder="Enter Exam Date" value="{{ $exam->Exam_Date }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="Exam_Level">Exam Level</label>
                                            <input type="text" class="form-control" id="Exam_Level" name="Exam_Level" placeholder="Enter Exam Level" value="{{ $exam->Exam_Level }}"/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="slug">Slug</label>
                                            <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter slug" value="{{ $exam->slug }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="content">Content</label>
                                            <textarea class="form-control" id="content" name="content" placeholder="Write content">{{ $exam->content }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="status">Status</label>
                                            <select class="form-control" name="status" id="status">
                                                <option value="1" {{ $exam->status ? "selected" : "" }}>Publish</option>
                                                <option value="0" {{ !$exam->status ? "selected" : "" }}>Draft</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" id="category" style="width: 100%;">
                                                ...
                                                <option value="{{ $category->id }}" {{ $exam->category_id == $category->id ? "selected" : "" }}>{{ $category->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
