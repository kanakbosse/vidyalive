...
@section("title", $banner->title." - ".config('app.sitesettings')::first()->site_title)
             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="section-heading-2-title">
                         <h1>{{ $banner->title }}</h1>
                         <p class="links"><a href="{{ route("frontend.home") }}">Home <i class="las la-angle-right"></i></a> {{ $banner->title }}</p>
                     </div>
                 </div>
             </div>
         </div>
                ...
                <div class="post-list post-list-style2">
                    ...
                    <div class="post-list-content">
                        ...
                        <ul class="entry-meta">
                            ...
                            <li class="entry-cat"><a href="{{ route("frontend.banner", $post->banner->slug) }}" class="banner-style-1"><span class="line"></span>{{ $post->banner->title }}</a></li>
