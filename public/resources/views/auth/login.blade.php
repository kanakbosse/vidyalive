...
<section class="login p-0 py-5">
    ...
    .wm-student-settings-info{ display: flex; margin-top: 200px !important; align-items: center; justify-content: center; margin-bottom: 100px}
    ...
    .wm-main-section{ background: #676767; padding-top: 0px !important}
    .wm-main-content{ padding-top: 0px !important}
