                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a target="_blank" href="{{ $user->status ? route("frontend.user", $user->username) : "" }}" class="btn btn-success {{ $user->status ? "" : " disabled" }}"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route("dashboard.users.edit", $user->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
