                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a class="float-right btn btn-primary " href="{{ route("dashboard.categories.create") }}">Add Course</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a target="_blank" href="{{ $category->status ? route("frontend.category", $category->slug) : "" }}" class="btn btn-success {{ $category->status ? "" : " disabled" }}"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route("dashboard.categories.edit", $category->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
