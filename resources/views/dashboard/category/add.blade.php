                                ...
                                <div class="row">
                                    <div class="col-md-8 mx-auto">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="duration" name="duration" placeholder="Enter Duration" value="{{ old('duration') }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="college">college</label>
                                            <input type="text" class="form-control" id="college" name="college" placeholder="Enter college" value="{{ old('college') }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="sort_description">Sort Description</label>
                                            <textarea class="form-control" id="sort_description" name="sort_description" placeholder="Enter sort description" class="form-control">{{ old('sort_description') }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea class="form-control" id="description" name="description" placeholder="Enter description" class="form-control">{{ old('description') }}</textarea>
                                        </div>
