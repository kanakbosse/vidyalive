                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a target="_blank" href="{{ $post->status ? route("frontend.post", $post->slug) : "" }}" class="btn btn-success {{ $post->status ? "" : " disabled" }}"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route("dashboard.posts.edit", $post->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
