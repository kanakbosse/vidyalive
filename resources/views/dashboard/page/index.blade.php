                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a target="_blank" href="{{ $page->status ? route("frontend.page", $page->slug) : "" }}" class="btn btn-success {{ $page->status ? "" : " disabled" }}"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route("dashboard.pages.edit", $page->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
