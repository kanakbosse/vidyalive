    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ in_array(request()->route()->getName(), ["dashboard.unipages.index", "dashboard.unipages.create", "dashboard.unipages.edit", "dashboard.unipages.trashed"]) ? "menu-open" : "" }}">
                    <a href="#" class="nav-link {{ in_array(request()->route()->getName(), ["dashboard.unipages.index", "dashboard.unipages.create", "dashboard.unipages.edit", "dashboard.unipages.trashed"]) ? "active" : "" }}">
                        <i class="nav-icon fas fa-copy"></i>
                        <p>Universities<i class="right fas fa-angle-left"></i>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route("dashboard.unipages.index") }}" class="nav-link {{ request()->route()->getName() == "dashboard.unipages.index" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Universities</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("dashboard.unipages.create") }}" class="nav-link {{ request()->route()->getName() == "dashboard.unipages.create" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New University</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route("dashboard.unipages.trashed") }}" class="nav-link {{ request()->route()->getName() == "dashboard.unipages.trashed" ? "active" : "" }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Trashed Universities</p>
                            </a>
                        </li>
                    </ul>
                </li>
