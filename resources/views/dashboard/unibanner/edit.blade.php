            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route("dashboard.banner.index") }}">All Banners</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.banner.update", $banner->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="row">
                                    <div class="col-md-8 mx-auto">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter slug" value="{{ $banner->slug }}"/>
                                        </div>
                                    ...
                                    <div class="col-md-4 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <img id="imagepreview" class="img-fluid img-thumbnail mt-3" src="{{ asset("uploads/banner/".($banner->image ?? "default.webp")) }}"/>
                                        </div>
                                        <div class="form-group">
