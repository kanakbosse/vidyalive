...
// use App\Http\Controllers\Frontend\UniPageController;
...
use App\Http\Controllers\Dashboard\UniPageController as DashboardUniPageController ;
...
Route::name("dashboard.")->prefix("/dashboard")->middleware(["auth"])->group(function() {
    ...
    Route::resource("/pages", DashboardPageController::class)->except(["show"])->middleware(["admin"]);
     ...
     // unipages
     Route::prefix("/unipages")->name("unipages.")->controller(DashboardUniPageController::class)->middleware(["admin"])->group(function() {
        Route::get("/{id}/status", "status")->name("status");
        Route::get("/trashed", "trashed")->name("trashed");
        Route::get("/{id}/restore", "restore")->name("restore");
        Route::delete("/{id}/delete", "delete")->name("delete");       
    ...
    Route::resource("/unipages", DashboardUniPageController::class)->except(["show"])->middleware(["admin"]);
